...
<head>
    <meta charset="UTF-8">
    <title>Nuevo Problema ITIL</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-item">
            <a href="index.php">
                <svg>
                    <path d="M10 2L2 8h2v8h4V12h4v4h4V8h2z" />
                </svg>
        ...
        <div class="nav-item">
            <a href="calendario.php">
                <svg>
                    <path d="M6 2v2H4v2h12V4h-2V2h-2v2H8V2H6zm12 6H2v10h16V8z" />
                </svg>
        ...
        <div class="nav-item">
            <a href="logout.php">
                <svg>
                    <path d="M16 13v-2H7V8l-5 4 5 4v-3h9zm2-10H8v2h10v14H8v2h10a2 2 0 002-2V5a2 2 0 00-2-2z" />
                </svg>
    ...
    <!-- === MAIN: FORMULARIO NUEVO PROBLEMA === -->
    <div class="main">

        <h4 class="mb-3">Registrar nuevo problema</h4>

        <div class="card-itil">

            <form method="post" action="itil_problema_accion.php">

                <input type="hidden" name="accion" value="crear_problema">
                ...
                <div class="mb-3">
                    <label class="form-label">Causa raíz (opcional)</label>
                ...
                <div class="mb-3">
                    ...
                    <select name="estado" class="form-select">
                        <option value="Investigando" selected>Investigando</option>
                ...
                <button class="btn btn-primary">Guardar problema</button>
