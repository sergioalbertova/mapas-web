...
.filtro-bar{
    ...
    width:100%;
    max-width:700px;
    margin:80px auto 25px auto; /* centra horizontal */
}
``
...
<div class="filtro-bar">
    ...
    <div class="filtro-rapidos filtro-row botones-pro">
...
<div class="filtro-filtro-activo">
    ...
    <a href="<?= htmlspecialchars($urlSinTecnico) ?>" class="btn-clear">
    Quitar filtro
</a>
</div>
<?php endif; ?>
